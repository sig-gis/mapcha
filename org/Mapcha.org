...
* TODOs
** Admin page
   - Add the spinner.gif after the "Create and launch this project" button on the Admin page, and change the text to "Processing...please wait..."
   ...
   - Create a panel for reviewing, editing (add new user-specified plots w/ unique user_entered field), and deleting existing projects
...
** Dashboard page
   ...
   - Allow for multiple points to be selected and assigned the same value
   - Make the size of sample circles vary with the zoom level
   - Increase the sensitivity of the point selection tool
