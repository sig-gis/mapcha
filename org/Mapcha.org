...
** Database changes
   ...
   - Add a date field and an imagery field to the user_samples table and recreate it on euclid and mapcha
   - Create a mapcha.imagery table with fields (id, source, date, url) on euclid and mapcha
